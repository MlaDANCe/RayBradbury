namespace HeroesPrototype
{
    ...
    public partial class Trainer : Form
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            if (uint.TryParse(txtGold.Text, out uintNum)) mainScene.MainCharacter.Gold += uintNum;
            if (uint.TryParse(txtWood.Text, out uintNum)) mainScene.MainCharacter.Wood += uintNum;
            if (uint.TryParse(txtOre.Text, out uintNum)) mainScene.MainCharacter.Ore += uintNum;
            ...
            if (uint.TryParse(txtXp.Text, out uintNum)) mainScene.MainCharacter.Experience += uintNum;
        }
